 ...
 *****************************************************************************/
#ifndef STARLING_MLX90393
#define STARLING_MLX90393
 ...
 */
class Starling_MLX90393 : public Adafruit_Sensor {
public:
  Starling_MLX90393();
  ...
  bool enableTemperatureCompensation(bool state);
  bool enableZSeriesConnection(bool state);
